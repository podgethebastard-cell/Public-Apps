...
# Initialize API (Fixed Initialization)
cg = CoinGeckoAPI()  # Initialize first
cg.session = get_retry_session()  # Then inject custom session
...
with tabs[1]:
    ...
    if not df_ta.empty:
        ...
        try:
            ...
            pass # Graceful fail if indicators didn't calculate
